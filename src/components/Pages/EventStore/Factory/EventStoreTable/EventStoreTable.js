...
export default class EventStoreTable extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      data: this.props.mercury.factoryEventStores,
      page: 1,
    }
  }
  ...
  handleSortOrderChange(key, order) {
    ...
    let data = _.sortBy(this.props.mercury.factoryEventStores, [key])
    if (order === 'desc'){
      data.reverse()
    }
    this.setState({
  ...
  handleFilterValueChange(value) {
    ...
    let data = this.props.mercury.factoryEventStores
    if (value !== ''){
  ...
  handleRowSelection(selectedRows) {
    ...
    let selectedEs = this.props.mercury.factoryEventStores[selectedRows]
